    ...
    return (
        <>
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Categorias</h2>
                    <p className="text-gray-700 dark:text-white/80">Organize seus decks por categorias</p>
                </div>
